...
import com.bw.movie.adapter.FuJinAdapter;
 ...
 * function：
 */
public class FuJinFragment extends BaseFragment<UserPresenter> implements UserContract.UserView {
    @BindView(R.id.fujin_recycler)
    RecyclerView fujinRecycler;
    ...
    public void UserViewFuJinSuccess(FuJinBean fuJinBean) {
        ...
        fujinRecycler.setLayoutManager(linearLayoutManager);
        //设置适配器
        FuJinAdapter fuJinAdapter = new FuJinAdapter(getActivity(), result);
        fujinRecycler.setAdapter(fuJinAdapter);
    ...
    protected void initData() {
        super.initData();
     mPresenter.UserPresenterFuJin("116.30551391385724","40.04571807462411","1","10");
    }
