 ...
 * function：
 */
public class YingPingFragment extends BaseFragment<UserPresenter> implements UserContract.UserView {
    @BindView(R.id.yingping_recycler)
    RecyclerView yingpingRecycler;
    ...
    protected int provideLayoutId() {
        return R.layout.yingping_layout;
    }

    @Override
    protected void initData() {
        super.initData();
        mPresenter.UserPresenterYingPing("157422988241913692","13692","1","1","10");
    }
    ...
    public void UserViewYingPingSuccess(YingPingBean yingPingBean) {
        ...
        yingpingRecycler.setLayoutManager(linearLayoutManager);
        //设置适配器
        YingPingAdapter yingPingAdapter = new YingPingAdapter(getActivity(), result);
        yingpingRecycler.setAdapter(yingPingAdapter);
