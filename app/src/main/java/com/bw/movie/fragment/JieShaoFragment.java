...
import com.bw.movie.adapter.JieShaoDuo_Adapter;
 ...
 * function：
 */
public class JieShaoFragment extends BaseFragment<UserPresenter> implements UserContract.UserView {
    @BindView(R.id.jieshao_recycler)
    RecyclerView jieshaoRecycler;
    ...
    protected void initData() {
        ...
        mPresenter.UserPresenterJieShao("15741517482529734", "9734", id);
    ...
    public void UserViewJieShaoSuccess(JieShaoBean jieShaoBean) {
        JieShaoBean.ResultBean result = jieShaoBean.getResult();
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
        jieshaoRecycler.setLayoutManager(linearLayoutManager);
        JieShaoDuo_Adapter jieShaoDuo_adapter = new JieShaoDuo_Adapter(result, getActivity());
        jieshaoRecycler.setAdapter(jieShaoDuo_adapter);
