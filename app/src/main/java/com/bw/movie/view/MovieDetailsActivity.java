...
public class MovieDetailsActivity extends BaseActivity<UserPresenter> implements UserContract.UserView {


    @BindView(R.id.moview_details_fanhui)
    ImageView moviewDetailsFanhui;
    @BindView(R.id.chakan_dianying)
    TextView chakanDianying;
    private String id;
    ...
    @OnClick({R.id.moview_details_fanhui, R.id.chakan_dianying})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.moview_details_fanhui:
                break;
            case R.id.chakan_dianying:
                //点击跳转到详情
                Intent intent = new Intent(MovieDetailsActivity.this, Movieschedule.class);
